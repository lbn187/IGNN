...
def main():
    ...
    parser.add_argument('--starteval_epoch', type=int, default=100)
        ...
        for epoch in range(1, 1 + args.epochs):
            ...
            if epoch > args.starteval_epoch:
                ...
                for key, result in results.items():
                    ...
                    if valid_hits > 0.7 and key == "Hits@20":
                        print(key)
