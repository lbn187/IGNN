...
def main():
    ...
    f = open("ppa/train_pos_anchordis.txt","r")
    lines = f.readlines()
    ...
    for run in range(args.runs):
        ...
        for epoch in range(1, 1 + args.epochs):
            ...
            if epoch > args.starteval_epoch:
                valid_loss, test_loss, results = test(model, predictor, emb.weight, datax, data, valid_pos_edge, valid_pos_edge_info, valid_neg_edge, valid_neg_edge_info, test_pos_edge, test_pos_edge_info, test_neg_edge, test_neg_edge_info, evaluator, args.batch_size, device)
